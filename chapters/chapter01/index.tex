...
% If you use BibTex for your bibliography, please use
% \bibliography{path/to/bibtexfile}
%
% NOTE:
% you can use relative paths to the chapter root dir inside \input, \figure, etc., e.g. \figure{assets/fig1},
% however, this does not work for all commands, e.g. in \bibliography{}, you have to use \bibliography{\CHAPTERSROOT/chapterXX/bibl/bibliography}; with XX = your chapter number (e.g. chapter01).
