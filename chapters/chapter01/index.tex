...
For instance, the $\pi$-calculus \cite{short:MilnerR:calmp1} focuses on communicating systems and features the following constructs:
  ...
  actions $\pi.P$.
The action in the $\pi$-calculus are sending ($a(\vec a)$), receiving ($\overline{a}\langle \vec a \rangle$), and internal $\tau$. \todo{CSP notation?}
