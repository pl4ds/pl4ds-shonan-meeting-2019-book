...
\section{Algorithmic and Implementation Aspects} %(2pp)
    ...
    % recent survey: https://ieeexplore.ieee.org/document/7509657, https://d-scholarship.pitt.edu/32584/1/TimeSynchSurvey-Final.pdf (no paywall link)
    % assuming clock sync is needed to implement some languages: work by Lee at Berkley
 
    \subsection{Robustness against Perturbation of Communication}

    example: work on Skorokhod Distance by Rupak Majumdar and similar work by Ichiro Hasuo
