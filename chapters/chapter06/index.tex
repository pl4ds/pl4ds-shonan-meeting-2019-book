%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% chapter06 - Orchestration Languages
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\newcommand*{\chapterprefix}{06}	% your chapter number.
%
...
\begin{bibunit}
	...
	\title*{Orchestration Languages}
	\author{Heather Miller and Sebastian Burckhardt}
	
	\institute{
		Heather Miller \at Northeastern University, USA, \email{heather.miller@cs.cmu.edu}
