%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% chapter07 - Cost-based and Quantitative Models
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\newcommand*{\chapterprefix}{07}	% your chapter number.
%
...
\begin{bibunit}
	...
	\title*{Cost-based and Quantitative Models}
	\author{Nadeem Jamali}
	
	\institute{
		Nadeem Jamali \at University of Saskatchewan, Canada, \email{jamali@cs.usask.ca}
...
\section{Timed Rebeca}
	...
	\subsection{Modeling and Programming Tips}

	\subsection{Analysis Support}
...
\section{CyberOrgs}
	...
	\subsection{Case Studies}
		...
		\subsubsection{System Resources}
			 ...
			 Meeting deadlines; Multi-tenancy; Grid computing; Power-efficiency

		\subsubsection{Attention Resources}

			Defragmenting time; Attention demand negotiation
...
\section{Recommendations}
	...
	\subsection{Making Cost/Time/Resource/Ownership Explicit}

	\subsection{Domains of Relevance}
