...
typechecking.
  ...
  use of first-class mailboxes,~\cite{CharalambidesPA19:actor-progress} propose
  a typing discipline which ensures progress for a more classic actor paradigm.
  %
